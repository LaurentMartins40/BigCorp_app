...
public class MeasureDaoImpl implements MeasureDao {
    ...
    @Override
    public void create(Measure measure) {jdbcTemplate.update("insert into Measure (id, instant, value_in_watt, captor_id) " +
    ...
    private Measure measureMapper(ResultSet rs, int rowNum) throws SQLException {
        ...
        captor.setId(rs.getString("captor_id"));Measure measure = new
                Measure(h2DateConverter.convert(rs.getString("instant")),
